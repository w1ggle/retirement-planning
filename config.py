...
NONTAXABLE_INTEREST = W2_INCOME + PENSION_INCOME + EMPLOYER_MATCH_INCOME + IRA_INCOME + HEALTH_PLAN_INCOME
...
ADJUSTED_GROSS_INCOME = NONTAXABLE_INTEREST + TAXABLE_SS #add the SS
